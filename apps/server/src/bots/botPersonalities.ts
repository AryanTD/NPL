...
export const PERSONALITIES: Record<PersonalityType, BotPersonality> = {
  ...
  BUDGET_SNIPER: { type: 'BUDGET_SNIPER', aggressionMult: 0.75, humanRivalMult: 1.05, minQuality: 45, minDelay: 2000, maxDelay: 3500, normalIncrement:  25_000, urgentIncrement:  25_000 },
